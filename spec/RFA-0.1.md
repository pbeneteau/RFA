...
- `system` event names in use: `timeout, held, hold_released, hold_expired, held_refused, room_ended, gone_quiet, task_overdue, gate_alert, gate_refused, message_held, approval_expired, floor_granted` plus, added in 0.1.8, `admitted, task_released, redacted` (section 9.7).
