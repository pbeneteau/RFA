...
| [06-agent-fabric](06-agent-fabric/REPORT.md) | 2026-08-29 | What does MuleSoft Agent Fabric (Salesforce, GA Oct 2025) share with RFA, where is it better, where is it not? | Landscape comparison, no spec change. Single-session web survey, NOT a multi-agent sweep: read its method note before trusting it |
