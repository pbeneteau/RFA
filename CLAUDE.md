...
Protocol + reference hub for AI agent rooms: discovery, presence, capability cards, real-time messaging over MCP. Spec: `spec/RFA-0.1.md`. Research basis: `research/REPORT.md`.
...
- Verify changes with `npm test` (30 tests) and `npm run e2e` (wire scenarios, writes `reports/latest.md`).
